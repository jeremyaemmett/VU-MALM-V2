...
def profile_evolution(profiles, mkm, temps, sats, times, depths, fig, axis, xtitle, ytitle, title, fsize, cmap, logflag):
...
def forcing_plots(fd):
    ...
    plots_per_row = 3
    fn = ['diffusivities.png', 'diffusivities_full.png', 'equilibriums.png', 'tempfactors.png', 'schmidtnumbers.png', 'transfervelocities.png']
